        ...
        onSubmit: values => {
            ...
            axios
                .post("http://localhost:5000/api/post",
                    {code: values.code, description: values.description, author: keycloak.tokenParsed?.preferred_username},
                    {
                        headers: {
        ...
        <main>
            <div className="w-full justify-center flex">
                {keycloak.authenticated && keycloak.hasRealmRole("admin") || keycloak.hasRealmRole("verified_company") ? (
                    <div className={"w-1/2 h-max m-10 p-6 flex flex-col items-center rounded bg-black z-10"}>
