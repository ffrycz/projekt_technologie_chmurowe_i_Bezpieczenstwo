    ...
    return (
        <div className={"flex w-full h-max"}>
            {keycloak.authenticated ? (
                ...
                <div className={"flex w-full h-max m-20 justify-center align-middle space-between"} >
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <div className={"text-gray-300 h-5 m-3 rounded-2xl text-2xl self-center"}>OR</div>
                        <button className={"h-15 w-48 rounded-2xl text-2xl"}>Sign In</button>
                    </div>
                </div>
            )}
        </div>
